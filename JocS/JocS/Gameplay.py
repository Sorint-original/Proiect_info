...
# dau inport la clasa de butoane deoarece sar putea sa avem un Pause Menu si
# cred ca nu o sal putem face separat de gameplay
import ButtonClass
from Player import Harmful_Stuff
import QuadTree

#input reprezinta un dictionar care indica care input(keyboard , controller) se
#duce la fiecare player , de asemenea as vrea un parameter MAP care e luat din
#MAPSELECT
...
def gameplay(WIN,WIDTH,HEIGHT,FPS,Input,Playeri,joysticks,Map,qTree):
    ...
    def environment_update() :
        ...
        #threads = []    
        #for i in range(len(Harmful_Stuff)):
        #    newThread = Thread(target = attack_stuff, args = (i,))
